...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oozd6iw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oozd6iw.containers.anotherwebservice.com/
...
```
git clone git@github.com:gagestinson/container-oozd6iw.git
cd container-oozd6iw
```
...
```
docker attach container-oozd6iw
```
